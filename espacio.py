...
with open('preguntas_espacio.json', 'r') as file:
    preguntas_espacio = json.load(file)
...
class ArbolPreguntas:
    ...
    def jugar(self):
        ...
        with open("preguntas_espacio.json", "w") as file:
            json.dump(self.preguntas, file, indent=4)
        
        modos_juego = ["ciudad", "mar", "montaña", "bosque"]
...
arbol = ArbolPreguntas(preguntas_espacio)
arbol.jugar()
