...
# Fondo
fondo = pygame.image.load("montana.png")
fondo = pygame.transform.scale(fondo, (ANCHO, ALTO))

# Cargar la imagen del jugador
image_jugador = pygame.image.load("alcón.png")
...
image = pygame.image.load('roca.png')
...
def move_obstacles():
    ...
    while True:
        if not pause:
            ...
            time.sleep(random.uniform(0.03, 0.03))  # Pausa aleatoria entre 10ms y 30ms
...
while running:
    ...
    if ganaste:
        running = False
        #subprocess.Popen(["python", "montana.py"])             #para ponerlo con las preguntas quitar el de abajo y quitar el comentario de
