...
with open('preguntas_océano.json', 'r') as file:
    preguntas_océano = json.load(file)
...
class ArbolPreguntas:
    ...
    def jugar(self):
        ...
        with open("preguntas_océano.json", "w") as file:
            json.dump(self.preguntas, file, indent=4)

        modos_juego = ["ciudad", "bosque", "montaña", "espacio"]
...
arbol = ArbolPreguntas(preguntas_océano)
arbol.jugar()
