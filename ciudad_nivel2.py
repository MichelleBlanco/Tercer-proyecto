...
pygame.mixer.music.load("ciudad.mp3")
...
image_jugador = pygame.image.load("persona.png")
...
while running:
    ...
    if ganaste:
        running = False
        #subprocess.Popen(["python", "ciudad.py"])
        subprocess.Popen(["python", "ciudad_nivel1.py"])         #quitar este y habilitar el comentado para las preguntas
