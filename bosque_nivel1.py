...
while running:
    ...
    if ganaste:
        running = False
        subprocess.Popen(["python", "bosque.py"])
        subprocess.Popen(["python", "bosque_nivel2.py"])              #quitar este y habilitar el otro para las preguntas
    elif perdiendo:
        running = False
